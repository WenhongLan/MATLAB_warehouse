...
ParentFolder = 'H:\WenhongTestFolder\SinglePatient\Sim_Patient_folder'; %highest folder containing all patient folder
...
clc;
iSelectScans=[1]; % []:= take all; [1 5 9]:= only specific
